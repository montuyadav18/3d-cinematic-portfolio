        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Interactive & Animative Experiences</h4>
              <p>
                I specialize in building visually stunning and highly interactive
                web interfaces using React, GSAP, and Three.js, focusing on
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Robust Web &amp; App Solutions</h4>
              <p>
                Expert in developing end-to-end applications with React and React
                Native, focusing on performance, scalability, and seamless mobile
                experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
